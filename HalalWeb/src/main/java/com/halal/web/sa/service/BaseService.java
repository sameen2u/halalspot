...
public abstract class BaseService
{
    ...
    throws ApplicationException
  {
    ...
    if (StringUtils.endsWithIgnoreCase(request.getMethod(), "GET"))
    {
      ...
      responseJson = invokeService(serviceURL, isCacheable());
    ...
    {
      responseJson = invokePostService(serviceURL, buildInputDataObject(request), MediaType.APPLICATION_JSON, isCacheable());
